...
const definition_management_1 = __nccwpck_require__(6279);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        const definition = core_1.getInput("definition");
        definition_management_1.validateInputs({ definition });
        const definitionArns = yield definition_management_1.getTaskDefinitionList(definition);
        if (definitionArns.length < 1) {
            core_1.info(`No task definitions found for family '${definition}'.`);
            return 0;
        }
        core_1.info(`De-registering task definitions associated to '${definition}'...`);
        yield definitionArns.reduce(definition_management_1.deregisterTaskDefinitionReducer, undefined);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getTaskDefinitionList = exports.validateInputs = exports.deregisterTaskDefinitionReducer = void 0;
...
function deregisterTaskDefinitionReducer(_accumulator, currentTaskDefinitionArn) {
    return __awaiter(this, void 0, void 0, function* () {
        const { taskDefinition } = yield getClient()
...
function getTaskDefinitionList(definition) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        do {
            ...
            arns = arns.concat((response === null || response === void 0 ? void 0 : response.taskDefinitionArns) || []);
        } while (nextToken);
        return arns;
    });
}
exports.getTaskDefinitionList = getTaskDefinitionList;
//# sourceMappingURL=definition-management.js.map
...
__exportStar(__nccwpck_require__(6279), exports);
