...
ARG APP_PATH=/icalia-actions/aws-deregister-ecs-task-definitions
...
ARG APP_PATH=/icalia-actions/aws-deregister-ecs-task-definitions
COPY --from=builder --chown=node:node ${APP_PATH} /icalia-actions/aws-deregister-ecs-task-definitions
WORKDIR /icalia-actions/aws-deregister-ecs-task-definitions
